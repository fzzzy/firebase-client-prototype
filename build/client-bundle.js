...
/***/ function(module, exports, __webpack_require__) {
	...
	var _client2 = __webpack_require__(292);
	...
	var Screen = function (_React$Component) {
	  ...
	  _createClass(Screen, [{
	    ...
	    value: function componentDidMount() {
	      var input = (0, _reactDom.findDOMNode)(this.refs.inputline);
	      input.focus();
	    }
	  }, {
	    key: "formSubmit",
	    ...
	    value: function render() {
	      var chatLines = this.props.chat.map(function (line, i) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement("input", { ref: "inputline" }),
	          React.createElement(
	            "button",
	            null,
	            "Send"
	...
	function createReducer(client) {
	  return function reduxStore(state, action) {
	    ...
	    switch (action.type) {
	      case "PUSH_CHAT":
	        var chat = JSON.parse(JSON.stringify(state.chat));
	...
	function main() {
	  var client = new _client2.FirebaseClient(baseUrl);
	  store = (0, _redux.createStore)(createReducer(client));
	  store.subscribe(draw);
	  client.on("put", function (val) {
	    if (val.data) {
	      if (val.path === "/") {
	        for (var index in val.data) {
	          var el = val.data[index];
	          if (el.chat) {
	            store.dispatch({ type: "PUSH_CHAT", chat: el.chat });
	          }
	        }
	      } else if (val.data.chat) {
	        store.dispatch({ type: "PUSH_CHAT", chat: val.data.chat });
	      }
	    }
	    console.log("put", val);
	  });
	  client.on("patch", function (val) {
	    console.log("patch", val);
	  });
	  client.on("close", function (val) {
...
/***/ function(module, exports) {
	...
	var FirebaseClient = function () {
	  ...
	  _createClass(FirebaseClient, [{
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        try {
	          for (var _iterator = _this.EVENTS[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            _this._sse.addEventListener(eventName, _this._onEvent.bind(_this, eventName));
	          }
	        } catch (err) {
	        ...
	        _this._sse.addEventListener("cancel", _this._onRemoteClose.bind(_this, "cancel"));
	        _this._sse.addEventListener("auth_revoked", _this._onRemoteClose.bind(_this, "auth_revoked"));
	        _this._sse.addEventListener("close", _this._onClose.bind(_this));
	        var resolved = false;
	        _this._sse.onerror = function (error) {
	          if (!resolved) {
	            reject(error);
	            return;
	          }
	    ...
	    key: "_update",
	    value: function _update(method, path, body) {
	      if (method === "DELETE") {
	        if (body !== null) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        req.onload = function () {
	          if (req.status != 200) {
	            ...
	            var _body = JSON.parse(req.responseText);
	            resolve(_body);
	          }
	        };
	        req.send(body || null);
	    ...
	    value: function off(eventName, callback) {
	      var l = this._handlers[eventName] || [];
	    ...
	    key: "emit",
	    value: function emit(eventName, argument) {
	      var _iteratorNormalCompletion2 = true;
	      var _didIteratorError2 = false;
	      var _iteratorError2 = undefined;

	      try {
	        for (var _iterator2 = (this._handlers[eventName] || [])[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCurrentOwner = __webpack_require__(300);

	var warning = __webpack_require__(301);
	var canDefineProperty = __webpack_require__(303);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(308);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(310);
	var warning = __webpack_require__(301);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMComponentTree = __webpack_require__(325);
	var ReactDefaultInjection = __webpack_require__(328);
	var ReactMount = __webpack_require__(447);
	var ReactPerf = __webpack_require__(348);
	var ReactReconciler = __webpack_require__(349);
	var ReactUpdates = __webpack_require__(345);
	var ReactVersion = __webpack_require__(321);

	var findDOMNode = __webpack_require__(454);
	var getNativeComponentFromComposite = __webpack_require__(455);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(326);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(338);
	var HTMLDOMPropertyConfig = __webpack_require__(362);
	...
	var ReactEventListener = __webpack_require__(420);
	...
	function inject() {
	  ...
	  if (process.env.NODE_ENV !== 'production') {
	    ...
	    if (/[?&]react_perf\b/.test(url)) {
	      var ReactDefaultPerf = __webpack_require__(445);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPropagators = __webpack_require__(331);
	var ExecutionEnvironment = __webpack_require__(338);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(330);
	var EventPluginHub = __webpack_require__(332);
	var EventPluginUtils = __webpack_require__(334);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPluginRegistry = __webpack_require__(333);
	var EventPluginUtils = __webpack_require__(334);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_assign(SyntheticEvent.prototype, {
	  ...
	  destructor: function () {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	      var noop = __webpack_require__(302);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PooledClass = __webpack_require__(297);
	var ReactFeatureFlags = __webpack_require__(347);
	var ReactPerf = __webpack_require__(348);
	var ReactReconciler = __webpack_require__(349);
	var Transaction = __webpack_require__(352);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPropagators = __webpack_require__(331);
	var ReactDOMComponentTree = __webpack_require__(325);
	var SyntheticMouseEvent = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SyntheticUIEvent = __webpack_require__(359);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMChildrenOperations = __webpack_require__(364);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMLazyTree = __webpack_require__(365);
	...
	var setInnerHTML = __webpack_require__(369);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(338);
	var escapeTextContentForBrowser = __webpack_require__(368);
	var setInnerHTML = __webpack_require__(369);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(302);
	var getMarkupWrap = __webpack_require__(373);
	var invariant = __webpack_require__(298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFromMixed = __webpack_require__(372);
	var getMarkupWrap = __webpack_require__(373);
	var invariant = __webpack_require__(298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoFocusUtils = __webpack_require__(377);
	var CSSPropertyOperations = __webpack_require__(379);
	var DOMLazyTree = __webpack_require__(365);
	var DOMNamespaces = __webpack_require__(387);
	var DOMProperty = __webpack_require__(326);
	var DOMPropertyOperations = __webpack_require__(388);
	var EventConstants = __webpack_require__(330);
	var EventPluginHub = __webpack_require__(332);
	var EventPluginRegistry = __webpack_require__(333);
	var ReactBrowserEventEmitter = __webpack_require__(393);
	var ReactComponentBrowserEnvironment = __webpack_require__(363);
	...
	var ReactDOMSelect = __webpack_require__(400);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusNode = __webpack_require__(378);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(326);
	var ReactDOMInstrumentation = __webpack_require__(389);
	var ReactPerf = __webpack_require__(348);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMDebugTool = __webpack_require__(390);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMUnknownPropertyDevtool = __webpack_require__(391);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentEnvironment = __webpack_require__(403);
	var ReactMultiChildUpdateTypes = __webpack_require__(374);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var instantiateReactComponent = __webpack_require__(405);
	var shouldUpdateReactComponent = __webpack_require__(410);
	var traverseAllChildren = __webpack_require__(304);
	var warning = __webpack_require__(301);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEmptyComponent = __webpack_require__(411);
	var ReactNativeComponent = __webpack_require__(412);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(308);
	var ReactNodeTypes = __webpack_require__(408);
	var ReactPerf = __webpack_require__(348);
	var ReactPropTypeLocations = __webpack_require__(313);
	var ReactPropTypeLocationNames = __webpack_require__(315);
	var ReactReconciler = __webpack_require__(349);
	var ReactUpdateQueue = __webpack_require__(409);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventListener = __webpack_require__(421);
	var ExecutionEnvironment = __webpack_require__(338);
	var PooledClass = __webpack_require__(297);
	var ReactDOMComponentTree = __webpack_require__(325);
	var ReactUpdates = __webpack_require__(345);
	...
	var getEventTarget = __webpack_require__(353);
	var getUnboundedScrollPosition = __webpack_require__(422);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusNode = __webpack_require__(378);
	var getActiveElement = __webpack_require__(431);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(302);
	var getEventCharCode = __webpack_require__(439);
	var invariant = __webpack_require__(298);
	var keyOf = __webpack_require__(316);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(326);
	var ReactDOMComponentTree = __webpack_require__(325);
	var ReactDefaultPerfAnalysis = __webpack_require__(446);
	var ReactMount = __webpack_require__(447);
	var ReactPerf = __webpack_require__(348);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCurrentOwner = __webpack_require__(300);
	var ReactDOMComponentTree = __webpack_require__(325);
	var ReactDOMContainerInfo = __webpack_require__(448);
	var ReactDOMFeatureFlags = __webpack_require__(449);
	var ReactElement = __webpack_require__(299);
	var ReactFeatureFlags = __webpack_require__(347);
	var ReactInstrumentation = __webpack_require__(308);
	var ReactMarkupChecksum = __webpack_require__(450);
	var ReactPerf = __webpack_require__(348);
	var ReactReconciler = __webpack_require__(349);
	var ReactUpdateQueue = __webpack_require__(409);
	var ReactUpdates = __webpack_require__(345);
